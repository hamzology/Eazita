...
public class msgs extends Fragment implements View.OnClickListener {
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        View view = inflater.inflate(R.layout.msgs, container, false);
        random = new Random();
        ...
        //return inflater.inflate(R.layout.msgs, container, false);
    }
    ...
    public void onViewCreated(View view, @Nullable Bundle savedInstanceState) {
       ...
       /* String[] mobileArray = {"Android","IPhone","WindowsMobile","Blackberry",
        ...
        //ArrayAdapter adapter = new ArrayAdapter(getActivity().getApplicationContext(),R.layout.msgs, mobileArray);
